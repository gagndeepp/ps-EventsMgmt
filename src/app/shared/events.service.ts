...
export class EventsService {
  ...
  getEvents(): Observable<IEvent[]> {
    return this.http
      ...
      .pipe(catchError(this.handleError('getEventsMethod', [])));
  }
  ...
  saveEvent(inputEvent) {
    ...
    return this.http
      .post<IEvent>('/api/events', inputEvent, options)
      .pipe(catchError(this.handleError<IEvent>('saveEventsMethod')));
  }
  ...
  getEvent(id: number): Observable<IEvent> {
    return this.http
      ...
      .pipe(catchError(this.handleError('getEvent Method', null)));
  }
}
